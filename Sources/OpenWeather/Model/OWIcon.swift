...
import Foundation
  ...
  extension OWIcon {
    ...
    static func multiColorSystemSymbol(_ name: String, accessibilityDescription: String? = nil)
      -> OWIcon?
    {
  ...
  extension OWIcon {
    ...
    static func multiColorSystemSymbol(_ name: String, accessibilityDescription: String? = nil)
      -> OWIcon?
    {
      return OWIcon(systemSymbolName: name, accessibilityDescription: accessibilityDescription)?
