...
protocol OWRequestPerforming {
  func perform<Object: Decodable>(_ request: URLRequest, urlSession: URLSession) async throws
    -> Object
}
...
actor OWRequestHandler: OWRequestPerforming {
  ...
  func perform<Object: Decodable>(_ request: URLRequest, urlSession: URLSession = URLSession.shared)
    async throws -> Object
  {
